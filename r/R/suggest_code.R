...
print.statlingo_code_suggestions <- function(x, ...) {
  ...
  cat("***\n")
  cat("*Caution: These code suggestions were generated by a Large Language Model. Users should critically review the code to ensure correctness and applicability before executing.*\n")
  invisible(x)
}
