...
expect_true(nchar(statlingua:::.read_prompt_file("common", "role_base.md")) > 0)
expect_equal(statlingua:::.read_prompt_file("nonexistent", "file.md"), "")

# Test .prompt_config()
config <- statlingua:::.prompt_config()
...
expect_true(grepl_robust_line_endings(statlingua:::.read_prompt_file("common", "role_base.md"),
                  prompt_lm_novice))
expect_true(grepl_robust_line_endings(statlingua:::.read_prompt_file("models", "lm", "role_specific.md"),
                  prompt_lm_novice))
...
expect_true(grepl_robust_line_endings(statlingua:::.read_prompt_file("models", "lm", "instructions.md"),
                  prompt_lm_novice))
...
expect_true(grepl_robust_line_endings(statlingua:::.read_prompt_file("models", "default", "instructions.md"),
                  prompt_default_assembly))
